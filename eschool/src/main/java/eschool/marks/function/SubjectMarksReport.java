...
/**
 * Servlet implementation class SubjectMarksReport
 */
@WebServlet("/SubjectMarksReport")
public class SubjectMarksReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<MarksReportBySubject> report = Service.marksReport(subject, yr, section);
		...
		try {
			...
			for(MarksReportBySubject r:report) {
				Phrase ph;
				c1 = new PdfPCell();
				c1.setPadding(10);
				c1.setBorderWidth((float) 0.25);

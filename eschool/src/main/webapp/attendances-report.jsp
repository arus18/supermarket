            ...
            <div class="u-body">
                ...
                <section class="es-form-area">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="NewAttendance" class="es-form es-add-form" method="POST">
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="title">Student ID</label>
                                        <input type="number" placeholder="Alexa" name="id" required>
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <div class="datepicker-wrap">
                                            <input type="date" id="datepicker" class="datepicker hasDatepicker" placeholder="25/12/2021" name="date" required>
                                        </div>
                                    </div>
                                     <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="subject">Status</label>
                                        <select id="subject" class="es-add-select" name="status">

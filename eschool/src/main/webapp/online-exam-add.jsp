            ...
            <div class="u-body">
                ...
                <section class="es-form-area">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="NewExam" class="es-form es-add-form" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                     ...
                                     <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <select id="subject" class="es-add-select" name="subject">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <input id="marks" type="number" placeholder="80" name="duration" required>
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">

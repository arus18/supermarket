...
<body>
		...
		<div id="content">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid">
                    ...
                    <form method="POST" class="form-inline" action="SearchProductForStock">
			...
			<div class="container-fluid">
				<div class="px-lg-5">
					...
					<div class="row">
						<%
						if (request.getAttribute("searchResultStock") != null) {
							ArrayList<Product> result = (ArrayList<Product>) request.getAttribute("searchResultStock");
								...
								<div class="p-4">
									<h5>
										<a href="#exampleModalCenter" data-toggle="modal"
											...
											data-product-id=<%=p.getProductID()%> data-product-name=<%=p.getName()%> data-product-img=<%="data:image/jpg;base64,"+b64img%> class="text-dark"><%=p.getName()%></a>
									</h5>
	...
	<script type="text/javascript">
		...
		$('#exampleModalCenter').on('show.bs.modal', function(e) {
			...
			var img = $(e.relatedTarget).data('product-img');
